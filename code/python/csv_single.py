...
# Iterate through subfolders inside 'texts'
for subfolder in ['EML']:  # Adjust subfolders as needed
...
for file_path in csv_files:
    try:
        ...
        df['fdr'] = os.path.basename(os.path.dirname(file_path))  # Assign folder name
...
if data:
    ddf = pd.concat(data, ignore_index=True)

    # Save to a new CSV file
    output_file = '/mwtx0006-nas01.bankofamerica.com/dcrs_acde$/POC/Gen_AI/ESO_Proj_May2025/Documents/texts/DF_SCN.csv'
    ddf.to_csv(output_file, index=False)
